...
namespace IndividualProject.Infrastructure.Migrations
{
    ...
    [Migration("20241126095524_changed-relationship-of-car")]
    partial class changedrelationshipofcar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IndividualProject.Domain.Entities.Track", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            EmployeeID = 3,
                            OccupationDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfficeRoomID = 2,
                            ParkingArrivalTime = new TimeSpan(429242669827),
                            ParkingDepartureTime = new TimeSpan(717242670562),
                            ParkingSpotID = 2
                        },
                        new
                        {
                            ...
                            OccupationDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfficeRoomID = 1,
                            ParkingArrivalTime = new TimeSpan(429242671549),
                            ParkingDepartureTime = new TimeSpan(717242671551),
                            ParkingSpotID = 4
                        },
                        new
                        {
                            ...
                            OccupationDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfficeRoomID = 1,
                            ParkingArrivalTime = new TimeSpan(429242671556),
                            ParkingDepartureTime = new TimeSpan(717242671558),
                            ParkingSpotID = 1
                        },
                        new
                        {
                            ...
                            OccupationDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfficeRoomID = 2,
                            ParkingArrivalTime = new TimeSpan(429242671562),
                            ParkingDepartureTime = new TimeSpan(717242671563),
                            ParkingSpotID = 3
                        },
                        new
                        {
                            ...
                            OccupationDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfficeRoomID = 2,
                            ParkingArrivalTime = new TimeSpan(429242671567),
                            ParkingDepartureTime = new TimeSpan(717242671569),
                            ParkingSpotID = 2
                        },
                        new
                        {
                            ...
                            OccupationDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfficeRoomID = 1,
                            ParkingArrivalTime = new TimeSpan(429242671573),
                            ParkingDepartureTime = new TimeSpan(717242671575),
                            ParkingSpotID = 2
                        },
                        new
                        {
                            ...
                            OccupationDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OfficeRoomID = 1,
                            ParkingArrivalTime = new TimeSpan(429242671579),
                            ParkingDepartureTime = new TimeSpan(717242671580),
                            ParkingSpotID = 4
                        });
                });
